...
오픈소스 전략을 채택한 많은 회사들은 클라이언트들에게 오픈소스 커뮤니티의 구성원이 되는 것을 요구합니다. 그렇지 않고서야 사용자 지원은 해주지만 로드맵 충돌이 생기는 것은 어쩔 수 없는 일입니다.
...
그래도 일로 하다보니 지치고 정이 떨어질 것만 같았습니다. 그런데 심적으로 지쳐있던 시기에 Mattermost에서 이런 편지 한통이 날아옵니다.
